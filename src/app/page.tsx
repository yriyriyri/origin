...
export default function Home() {
  ...
  // Heightmap intensity fades out as the about section scrolls in
  const heightFade = clamp01(1 - aboutProgress);
    ...
    <>
      ...
      >
        <div className="boids-bg">
          <Boids disperse={disperseAmount} heightFade={heightFade} />
          <div
